         ...
         <div class="col-md-4" style="float:left">
            <div class="card mb-2">
               ...
               <div class="card-body">
                  ...
                  <button type="button" class="button" onclick="location.href='{{route('quiz.viewQuiz', ['pnn', 'easy'])}}'">Ezzzzz</button>
               </div>
            </div>
         </div>
         <div class="col-md-4" style="float:left">
            <div class="card mb-2">
               ...
               <div class="card-body">
                  ...
                  <button type="button" class="button" onclick="location.href='{{route('quiz.viewQuiz', ['pnn', 'intermediate'])}}'">Not Bad</button>
               </div>
            </div>
         </div>
         <div class="col-md-4" style="float:left">
            <div class="card mb-2">
               ...
               <div class="card-body">
                  ...
                  <button type="button" class="button" onclick="location.href='{{route('quiz.viewQuiz', ['pnn', 'advanced'])}}'">Seriously!</button>
               </div>
            </div>
         </div>
</div>
  ...
  <div class="w3-container" id="feedback" style="margin-top:75px">
    ...
    @csrf
      <div class="w3-section">
         <input type="hidden" name="Page" value="pnn">
