...
<!-- Sidebar/menu -->
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:290px;font-weight:bold;" id="mySidebar"><br>
...
during antenatal care. However, inter- and intra-observer variability is high with only a 30% positive predictive value for the classification of pathological outcomes.</p><br>
<div class="space"></div>
...
CTG traces. However, the main weakness with this approach is poor human interpretation which leads to high inter- and intra-observer variability.</p>
<ul>
	...
	decision without evidence of pathological outcome measures.</li>
</ul>
...
normal vaginal deliveries using foetal heart rate signals.</p>
  </div>
  <!-- simulation -->
